...
const items = [
	{
		...
		desc: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi illum dolores quos quasi incidunt iure nostrum nam alias quam delectus?',
		img: 'https://images.pexels.com/photos/28052378/pexels-photo-28052378.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
		link: 'https://lama.dev',
	},
	{
		id: 2,
	...
	return (
		...
		>
			<div className='h-[600vh] relative' ref={ref}>
				<div className='w-screen h-[calc(100vh-10rem)] flex items-center justify-center text-6xl text-center'>
					My Works
				</div>
